...
# ========== 配置区域 ==========
# 请在这里填入你的飞书应用凭证
FEISHU_APP_ID = os.getenv("FEISHU_APP_ID", "cli_a96b16b3a3241cc3")  # 替换为你的 App ID
FEISHU_APP_SECRET = os.getenv("FEISHU_APP_SECRET", "UienfOgDBKNAkosNrtPtigtaIZQYCWiw")  # 替换为你的 App Secret
# ==============================
